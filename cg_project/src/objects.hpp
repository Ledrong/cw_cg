...
public:
    ...
    int  getBoardHeight();
    void setDirectionModel(int directionModel_);
    int  getDirectionModel();
...
private:
    ...
    int xCell, yCell;
    int widthModel, heightModel, directionModel;
...
private:
    void markCellsNearBoard(int xCell, int yCell, int widthModel, int heightModel);
    void clearCellsNearBoard(int xCell, int yCell, int widthModel, int heightModel);
