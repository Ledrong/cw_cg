...
public:
    ...
    int addBoard(int xCell, int yCell, int modelLength, int modelHeight, int countFloors, int modelDirection);
    int addTable(int xCell, int yCell);
    int addBed(int xCell, int yCell, int modelDirection);
    int addChair(int xCell, int yCell, int modelDirection);
    int addTorsher(int xCell, int yCell);
    int addTv(int xCell, int yCell, int modelLength, int modelHeight, int countFloors, int modelDirection);
