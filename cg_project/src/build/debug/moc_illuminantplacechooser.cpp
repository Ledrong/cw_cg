...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_IlluminantPlaceChooser_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_IlluminantPlaceChooser_t qt_meta_stringdata_IlluminantPlaceChooser = {
    {
QT_MOC_LITERAL(0, 0, 22), // "IlluminantPlaceChooser"
QT_MOC_LITERAL(1, 23, 21), // "on_buttonBox_accepted"
QT_MOC_LITERAL(2, 45, 0), // ""
QT_MOC_LITERAL(3, 46, 21) // "on_buttonBox_rejected"

    },
    "IlluminantPlaceChooser\0on_buttonBox_accepted\0"
    "\0on_buttonBox_rejected"
};
#undef QT_MOC_LITERAL

static const uint qt_meta_data_IlluminantPlaceChooser[] = {
...
QT_INIT_METAOBJECT const QMetaObject IlluminantPlaceChooser::staticMetaObject = { {
    QMetaObject::SuperData::link<QDialog::staticMetaObject>(),
    qt_meta_stringdata_IlluminantPlaceChooser.data,
